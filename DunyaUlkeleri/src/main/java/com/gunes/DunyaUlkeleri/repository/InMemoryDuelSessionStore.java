...
@Repository
public class InMemoryDuelSessionStore implements DuelSessionStore {

    private final Map<String, DuelGameSession> sessionsById = new ConcurrentHashMap<>();
    ...
    @Override
    public DuelGameSession requireById(String sessionId) {
        ...
        final DuelGameSession session = sessionsById.get(normalizedId);
        if (session == null) {
    ...
    @Override
    public DuelGameSession requireByRoomCode(String roomCode) {
    ...
    @Override
    public void save(DuelGameSession session) {
    ...
    public void remove(String sessionId) {
        ...
        final String roomCode = sessionIdToRoomCode.remove(normalizedId);
        if (roomCode == null || roomCode.isBlank()) return;
        roomCodeToSessionId.remove(roomCode, normalizedId);
    }
