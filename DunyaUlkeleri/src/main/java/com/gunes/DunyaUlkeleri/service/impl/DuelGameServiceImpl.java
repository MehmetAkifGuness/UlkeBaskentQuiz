...
public class DuelGameServiceImpl implements DuelGameService {
    ...
    private final DuelVsBotSessionService vsBotSessionService;
    ...
    public CreateDuelSessionResponse createSession(CreateDuelSessionRequest request) {
        if (request != null && Boolean.TRUE.equals(request.getVsBot())) {
            return vsBotSessionService.createVsBotSession(request);
        }
